...
declare -A EXCLUDED_FILES=(
  ...
  ["crates/app/src/result_launch.rs"]="developer-facing tracing::warn! strings and launcher program names/arguments (xdg-open, open, explorer.exe, -R, --, /select,) only, verified in full; a refused launch reaches the user only as the typed UserNotice::FilesMovedOrMissing (HANDOFF-041)"
