...
pub const ALL_KEYS: &[MessageKey] = &[
    ...
    MessageKey::SourcesPathInputPlaceholder,
    MessageKey::SourcesRecursiveHint,
    ...
    MessageKey::BadgeKeyword,
    MessageKey::BadgeSemantic,
    ...
    MessageKey::ModelArtifactTokenizer,
    MessageKey::ModelArtifactOnnx,
    MessageKey::ModelDeliveryStoreUnavailable,
    MessageKey::ModelDeliveryConnection,
    MessageKey::ModelDeliveryVerification,
    MessageKey::ModelDeliveryLocalStorage,
    MessageKey::ModelDeliveryInternalState,
    MessageKey::ModelPersistenceSaving,
    MessageKey::ModelPersistenceFailed,
    MessageKey::ModelPersistenceRetry,
    // RFC-043
