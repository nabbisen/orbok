...
| 011 | [Storage Dashboard and Cleanup UX](done/011-storage-dashboard-and-cleanup-ux.md) | Implemented (unreleased) — closed 2026-09-24 (Task 099 follow-up): criteria 5 and 6 built by Task 099 (Advanced view Storage: "Prepare keyword search again", "Prepare search by meaning again"); criterion 7 met by §9a's Cancel/Confirm dialog (Task 086). Closure record: [closures/011](closures/011-storage-dashboard-and-cleanup-ux.md) |
...
| 038 | [Result Freshness, Trust Badges and Recovery Actions](done/038-result-freshness-trust-badges-and-recovery-actions.md) | main; release pending — criteria 1–10 evidenced, [closure record](closures/038-result-freshness-trust-badges-and-recovery-actions.md) |
...
| 064 | [What a Folder Covers](done/064-what-a-folder-covers.md) | Implemented (unreleased) — closed 2026-09-25 (Tasks 113 and 114): every file belongs to one folder (nested adds refused, folders above added ones combine them, search in a subfolder registers nothing, overlaps combined at startup) and a folder covers "This folder and subfolders" or "This folder only", chosen on its card. Closure record: [closures/064](closures/064-what-a-folder-covers.md) |
